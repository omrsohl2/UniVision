...
class GoogleSvg extends React.PureComponent<any> {
  render() {
    const {
      props = {
        fill: 'rgb(0, 0, 0)'
    ...
    return (
      <SvgIcon {...props} viewBox="0 0 486.392 486.392">
        <g>
          <path
            d="M395.193,0H91.198C40.826,0,0,40.826,0,91.198v303.995c0,50.372,40.826,91.198,91.198,91.198
          ...
          />
          <path
            d="M222.342,167.349c-4.317-32.771-28.059-59.097-53.017-59.857
          ...
          />
          <path
            d="M205.774,293.021c-7.357-2.371-15.473-3.8-24.137-3.891
